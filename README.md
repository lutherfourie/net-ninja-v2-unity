...
Only `com.netninja.determinism-analyzer` remains an embedded UPM package. See `AGENTS.md`,
`docs/adr/ADRS.md` (index) / `docs/adr/0019-right-sizing-skeleton-asmdefs-stack-strip-wasm.md`, and `docs/`.
